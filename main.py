...
# 화면 표시명 → KOSIS C2_NM 매핑 (이름이 다른 품목만)
_KOSIS_ITEM_ALIAS = {"소고기": "국산쇠고기"}
_KOSIS_ALIAS_REVERSE = {v: k for k, v in _KOSIS_ITEM_ALIAS.items()}
...
ITEM_ROW_MAP = {
    "라면":     6,
    "소고기":   13,   # Excel: 국산쇠고기 추정 행 (KOSIS alias: 국산쇠고기)
    "우유":     20,
    "달걀":     22,
    "식용유":   24,
    "생수":     63,
...
_PRICES_ITEMS_FB = {
    ...
    "소고기":    _lp([(0,110),(11,118),(23,119),(35,116),(47,115),(52,117)]),
...
_PRICES_ANNUAL_FB = {
    "라면":      {"2022":113,"2023":127,"2024":130,"2025":133},
    "소고기":    {"2022":115,"2023":119,"2024":116,"2025":115},
    "우유":      {"2022":111,"2023":119,"2024":122,"2025":125},
    "달걀":      {"2022":115,"2023":122,"2024":126,"2025":129},
    "식용유":    {"2022":139,"2023":131,"2024":126,"2025":125},
    "생수":      {"2022":106,"2023":111,"2024":115,"2025":117},
    "전기료":    {"2022":107,"2023":123,"2024":127,"2025":130},
    "도시가스":  {"2022":118,"2023":133,"2024":130,"2025":131},
    "휘발유":    {"2022":134,"2023":120,"2024":119,"2025":118},
    "택배이용료":{"2022":112,"2023":120,"2024":125,"2025":130},
    "샴푸":      {"2022":107,"2023":115,"2024":120,"2025":122},
    "화장지":    {"2022":108,"2023":114,"2024":117,"2025":120},
}
    ...
    if _KOSIS_KEY:
        ...
        if rows:
            ...
            for item_ko in ITEM_ROW_MAP:
                kosis_nm = _KOSIS_ITEM_ALIAS.get(item_ko, item_ko)
                price_items[item_ko] = [lookup.get(m, {}).get(kosis_nm) for m in months_set]
            # 연도별 평균
            ...
            for prd, item_vals in lookup.items():
                ...
                for kosis_nm, val in item_vals.items():
                    display_nm = _KOSIS_ALIAS_REVERSE.get(kosis_nm, kosis_nm)
                    if display_nm in ITEM_ROW_MAP:
                        year_sums[display_nm][yr].append(val)
            annual = {
